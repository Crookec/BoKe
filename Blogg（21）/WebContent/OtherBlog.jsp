...
//输入修改后信息
%>
<tr ><td width="200px">昵称：</td><td width="580px"><%=_nick %></td></tr>
<tr ><td width="200px">真实姓名：</td><td width="580px"><%=_name %> </td></tr>
<tr ><td width="200px">生日：</td><td width="580px"><%=_birth %> </td></tr>
<tr ><td width="200px">性别：</td><td width="580px"><%=_sex %> </td></tr>
<tr ><td width="200px">家庭住址：</td><td width="580px"><%=_address %> </td></tr>
<tr ><td width="200px">职业：</td><td width="580px"><%=_job %> </td></tr>
<tr ><td width="200px">工作单位：</td><td width="580px"><%=_workaddress %></td></tr>
</table>
</td>
</tr>
